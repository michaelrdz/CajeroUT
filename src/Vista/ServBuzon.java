 ...
 * @author Usuario
 */
public class ServBuzon extends javax.swing.JFrame {

    /**
     * Creates new form ServBuzon
     */
    public ServBuzon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtArea_txtBuzon = new javax.swing.JTextArea();
        btn_enviarBuzon = new javax.swing.JButton();
        ...
        txtArea_txtBuzon.setColumns(20);
        txtArea_txtBuzon.setRows(5);
        jScrollPane1.setViewportView(txtArea_txtBuzon);

        btn_enviarBuzon.setText("Enviar");

        jLabel1.setText("AVISO:");

        jLabel2.setText("Tu mensaje se enviará de forma anónima.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServBuzon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServBuzon().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JButton btn_enviarBuzon;
    ...
    private javax.swing.JMenuItem jMenuItem_servBuzon;
    ...
    public javax.swing.JTextArea txtArea_txtBuzon;
